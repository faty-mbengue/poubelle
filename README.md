...
YOLOv8 réalise trois tâches en une seule exécution :
...
Une interface utilisateur simple et ergonomique permet d’envoyer une image et d’obtenir la prédiction instantanément.
...
poubelle/
 ...
 ├── requirements.txt
 ├── README.md
 └── (éventuellement dataset.yaml si nécessaire)
...
Déploiement en un clic via ton repo
